...
while True:
    ...
    # Pega o mais alto e mais baixo e também o código deles
    if altura > maior:
        maior = altura
        codAl = codigo
    if altura < menor:
    ...
    # Pega o mais obeso e mais magro e também o código deles
    if peso > obeso:
        obeso = peso
        codObe = codigo
    if peso < magro:
...
# Contas
mediaAl = totalAl / cont
mediaPe = totalPe / cont

    

print(
    f'\nO cliente mais alto tem o código {codAl} tendo: {maior}\n'
    f'\nO cliente mais baixo tem o código {codBai} tendo: {menor}\n'
    f'\nO cliente mais obeso tem o código {codObe} tendo: {obeso}\n'
    f'\nO cliente mais magro tem o código {codMag} tendo: {magro}\n'
)
